...
The folders contain five different direcitonal diagrams moose to wolves, wolves to moose, moose to moose, wolves to wolves, and two way moose and wolves. 

Each has two .ipynb files one for creating json files, one to run them model, and two .json files parts and nets. 

Except for two-way which has sliding sheaf and additional analysis files. 
